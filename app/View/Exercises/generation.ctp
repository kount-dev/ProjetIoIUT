...
<?php echo $this->Form->create('Exercise'); ?>
    ...
    <?php
        echo $this->Form->input('Exercise.name', array('label' => false, 'placeholder' => 'Title'));
        echo $this->Form->input('Exercise.minimum_points', array('label' => false, 'placeholder' => 'Minimum points required'));
        echo $this->Form->input('Exercise.opening_date', array('label' => false, 'placeholder' => 'Open Date Time','id'=>'openDatePicker','type'=>'text'));
        echo $this->Form->input('Exercise.closing_date', array('label' => false, 'placeholder' => 'Close Date Time','id'=>'closeDatePicker', 'type'=>'text'));
        echo $this->Form->input('Exercise.Discipline', array('label'=>'Exersise\'s disciplines','type'=>'select','multiple'=>true));
