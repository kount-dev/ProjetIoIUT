<div class="groupLists index">
	<h2><?php echo __('Group Lists'); ?></h2>
	...
	<tr>
		<td><?php echo h($groupList['GroupList']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($groupList['GroupList']['created']); ?>&nbsp;</td>
		<td><?php echo h($groupList['GroupList']['modified']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $groupList['GroupList']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $groupList['GroupList']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $groupList['GroupList']['id']), null, __('Are you sure you want to delete # %s?', $groupList['GroupList']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
